...
| Python   | Flask (with `gpt2` model)   | [`python-gpt2`](https://github.com/scaffoldly/scaffoldly-examples/tree/python-gpt2)                       | [Function URL](https://mg5s5yi5qwfe6vibg6cknv3e7q0scvjy.lambda-url.us-east-1.on.aws)                 | ~7500 MB   |
